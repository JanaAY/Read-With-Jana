...
function updateBestSellers(nytimesBestSellers) {
  ...
  nytimesBestSellers.results.forEach(function(book) {
    ...
    saveIcon.src = "images/saveButton1.png";
    ...
    let isFavorite = false; // Keep track of favorite status
    function updateSaveButtonIcon() {
      saveIcon.src = isFavorite ? "images/saveButton2.png" : "images/saveButton1.png";
    }
        ...
        fetch("https://www.googleapis.com/books/v1/volumes?q=subject:" +
          ...
          .then(data => {
            ...
            if (!data.items || data.items.length === 0) {
                alert(`No data found for category: ${subject}`);
            }
...
function display_Books() {
  ...
  bookList.innerHTML = " ";
//   const bookList1 = document.querySelector("#intro1");
//   bookList1.innerHTML = '<h2 id="titles">FROM CATEGORIES / SEARCH: </h2>';
...
//   bookListSellers.innerHTML = '<h2 id="titles">FROM BEST SELLERS PAGE: </h2>';

//   const bookList2 = document.querySelector("#intro2");
//   bookList2.innerHTML = '<h2 id="titles">FROM BEST SELLERS PAGE: </h2>';
...
document.getElementById("my_library").addEventListener("click", (e) => {
  ...
  display_Books();
  display_bestSellers();
  if (favorites.length === 0 && bestSellersfavorites.length === 0) {
...
//   var hr = document.getElementById("scroll-hr");

//   if (window.scrollY > 0) {
//     hr.classList.add("hide-hr"); // Add the "hide-hr" class to hide <hr>
//   } else {
//     hr.classList.remove("hide-hr"); // Remove the "hide-hr" class to show <hr>
//   }
// });
